...
const metadata = {
    title: "ServiNET+",
    description: "La red de recaudo y servicios digitales más confiable para negocios de barrio en Latinoamérica. Facilita productos y servicios en línea, incrementa tus ganancias y sé el referente de tu comunidad.",
    keywords: "pagos digitales, recaudo, servicios, negocios de barrio, Latinoamérica, recargas, transferencias",
    openGraph: {
        title: "ServiNET+",
        description: "Facilita productos y servicios en línea ayudando a incrementar tus ganancias",
        type: "website"
    },
    icons: {
        icon: "/favicon.ico",
